...
class InventoryResponseSerializer(maxInvObjects: Int) extends BifrostSerializer[MessagesV1.InventoryResponse] {

  override def serialize(data: MessagesV1.InventoryResponse, w: Writer): Unit = {
  ...
  override def parse(r: Reader): MessagesV1.InventoryResponse = {
    ...
    MessagesV1.InventoryResponse(typeId, elems)
  }
}
