...
class KeySpec
  ...
  property("LookupPublickKey should return the correct public key to the address") {
    keyRingCurve25519.lookupPublicKey(addressCurve25519).get.address should eqvShow(addressCurve25519)

    keyRingEd25519.lookupPublicKey(addressEd25519).get.address should eqvShow(addressEd25519)
  }
