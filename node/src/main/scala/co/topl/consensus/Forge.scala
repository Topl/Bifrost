...
/**
 * The "Forge" contains the business-logic for producing a new block in a blockchain
 */
object Forge {
  ...
  case class Dependencies(
    ...
    def forge(implicit networkPrefix: NetworkPrefix): Either[Failure, Block] = {
      ...
      val publicKey = getPublicKey(matchingAddr).getOrThrow()
