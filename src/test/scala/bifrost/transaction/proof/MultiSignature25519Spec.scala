...
class MultiSignature25519Spec extends PropSpec
  ...
  property("A MultiSignature25519 created from single Signature25519 should be valid for oneOfNProposition") {
  ...
  property("A MultiSignature25519 created from single Signature25519 should not be valid for twoOfNProposition") {
