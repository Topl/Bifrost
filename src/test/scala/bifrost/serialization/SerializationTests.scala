...
class SerializationTests
  ...
  property("oneOfNProposition Serialization") {
    forAll(oneOfNPropositionGen) { case (_, mn: MofNProposition) =>
  ...
  property("PolyTransfer Serialization") {
    forAll(polyTransferGen) { sc: PolyTransfer =>
  ...
  property("ArbitTransfer Serialization") {
    forAll(arbitTransferGen) { ac: ArbitTransfer =>
  ...
  property("AssetTransfer Serialization") {
    forAll(assetTransferGen) { at: AssetTransfer =>
  ...
  property("ProgramCreation Serialization") {
    forAll(programCreationGen) { c: ProgramCreation =>
  ...
  property("ProgramMethodExecution Serialization") {
    forAll(programMethodExecutionGen) { c: ProgramMethodExecution =>
  ...
  property("AssetCreation Serialization") {
    forAll(assetCreationGen) { ac: AssetCreation =>
  ...
  property("CodeCreation Serialization") {
    forAll(codeBoxCreationGen) { ccc: CodeCreation =>
  ...
  property("ProgramTransfer Serialization") {
    forAll(programTransferGen) { pt: ProgramTransfer =>
...
//  }
  ...
  property("Bloom Serialization") {
    forAll(intSeqGen) { intSeq: Seq[Int] =>
