...
$c_LLoan$.prototype.fromJSON__T__s_util_Try = (function(json) {
  try {
    var parsed = $g.JSON.parse(json);
    return new $c_s_util_Success().init___O(new ($a_LLoan())($as_s_math_BigInt(parsed.principal), $as_s_math_BigInt(parsed.accruedInterest), $as_s_math_BigInt(parsed.paymentInterval), $as_s_math_BigDecimal(parsed.interestRate), $as_s_math_BigInt(parsed.interestInterval), $as_s_math_BigInt(parsed.startingDate), $as_s_math_BigInt(parsed.totalPaid), $as_s_Option(parsed.lastPayment), $as_s_Option(parsed.nextPayment)))
  } catch (e) {
...
function $s_LLoan__makePayment__LLoan__s_math_BigInt__LLoan($this, amount) {
...
function $a_LLoan() {
  if ((!$b_LLoan)) {
    ...
    $c_LLoan.prototype.makePayment = (function(arg$1) {
      var prep0 = $as_s_math_BigInt(arg$1);
      return $s_LLoan__makePayment__LLoan__s_math_BigInt__LLoan(this, prep0)
    });
    $c_LLoan.fromJSON = (function(arg$1) {
      var prep0 = $as_T(arg$1);
      return $m_LLoan$().fromJSON__T__s_util_Try(prep0)
    });
