...
case class MemPool[TX <: Transaction[_, _ <: Proposition, _ <: Proof[_], _ <: Box[_]]](unconfirmed: TrieMap[ModifierId, TX])
...
object MemPool {
  lazy val emptyPool: MemPool[_ <: Transaction[_, _ <: Proposition, _ <: Proof[_], _ <: Box[_]]] = MemPool(TrieMap())
}