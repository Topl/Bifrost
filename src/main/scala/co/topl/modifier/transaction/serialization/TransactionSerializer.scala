...
object TransactionSerializer extends BifrostSerializer[Transaction[_, _ <: Proposition, _ <: Box[_]]] {

  override def serialize( obj: Transaction[_, _ <: Proposition, _ <: Box[_]], w: Writer): Unit = {
    obj match {
...
//        ProgramTransferSerializer.serialize(obj, w)
  ...
  override def parse(r: Reader): Transaction[_, _ <: Proposition, _ <: Box[_]] = {
    r.getByte() match {
