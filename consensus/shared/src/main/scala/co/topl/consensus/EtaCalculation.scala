  ...
  object Eval {
    ...
    def make[F[_]: Clock: Sync: MonadError[*[_], Throwable]: Logger](
      ...
      for {
        ...
        impl = new Impl[F](slotDataCache, clock, genesisEta, slotsPerEpoch, blake2b256Resource, blake2b512Resource, c)
      } yield impl
    ...
    private class Impl[F[_]: Clock: Sync: MonadError[*[_], Throwable]: Logger](
          ...
          (
            ...
            .flatMap {
              ...
              case (_, _, parentSlotData) =>
                cache.cachingF(parentSlotId.blockId.show)(ttl = None)(
      ...
      private def calculate(twoThirdsBest: SlotData): F[Eta] =
        cache.cachingF(twoThirdsBest.slotId.blockId.show)(ttl = None)(
          for {
