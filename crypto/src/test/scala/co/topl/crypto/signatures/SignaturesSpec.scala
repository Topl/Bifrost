...
class SignaturesSpec extends AnyPropSpec with ScalaCheckDrivenPropertyChecks with Matchers {

  property("with Curve25519, signed message should be verifiable with appropriate public key") {
