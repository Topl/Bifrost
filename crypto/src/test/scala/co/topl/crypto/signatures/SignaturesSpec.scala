...
class SigningFunctionsSpecification extends AnyPropSpec
  ...
  property("test vectors from https://tools.ietf.org/html/rfc8032#page-24 - test 1") {
    ...
    val specSig = Hex.decode("e5564300c360ac729086e2cc806e828a84877f1eb8e5d974d873e065224901555fb8821590a33bacc61e" +
  ...
  property("test vectors from https://tools.ietf.org/html/rfc8032#page-24 - test 2") {
    ...
    val sig = Curve25519.sign(privKey, message)
    val specSig = Hex.decode("92a009a9f0d4cab8720e820b5f642540" +
  ...
  property("test vectors from https://tools.ietf.org/html/rfc8032#page-24 - test 3") {
    ...
    val sig = Curve25519.sign(privKey, message)
    val specSig = Hex.decode("6291d657deec24024827e69c3abe01a3" +
  ...
  property("test vectors from https://tools.ietf.org/html/rfc8032#page-24 - test 1024") {
    ...
    val message = Hex.decode("08b8b2b733424243760fe426a4b54908632110a66c2f6591eabd3345e3e4eb98fa6e264bf09efe12ee50" +
    ...
    val sig = Curve25519.sign(privKey, message)
    val specSig = Hex.decode("0aab4c900501b3e24d7cdf4663326a3a87df5e4843b2cbdb67cbf6e460fec350aa5371b1508f9f4528ec" +
  ...
  property("test vectors from https://tools.ietf.org/html/rfc8032#page-24 - test SHA") {
    ...
    val message = Hex.decode("ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836" +
      "ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f")
    val sig = Curve25519.sign(privKey, message)
    val specSig = Hex.decode("dc2a4459e7369633a52b1bf277839a00201009a3efbf3ecb69bea2186c26b58909351fc9ac90b3ecfdf" +
