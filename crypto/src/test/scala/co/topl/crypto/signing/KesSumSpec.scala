...
class KesSumSpec extends AnyFlatSpec with ScalaCheckPropertyChecks with ScalaCheckDrivenPropertyChecks with Matchers {
  ...
  it should "Test Vector - 1.0: Generate and verify a specified sum composition signature at t = 0 using a provided seed, message, and height" in {
    val kesSum = new KesSum()
    val specIn_seed = "5b74fae39b7a367da736490fa4a2bac992d011bcfb1d39b4dfdb4cf3a6dd1def".hexStringToBytes
    val specIn_height = 1
    val specIn_time = 0
    val specIn_msg = "6c616e677561676520736861726573206120636f6d6d6f6e20746f6e677565".hexStringToBytes
    ...
    val specOut_sig_0 = Proofs.Signature.KesSum(
      ...
      Vector(
        "6d44789d918310507d283b48c57b96a94f68b2fd13969df8d1ce1356a0726574".unsafeStrictBytes
      )
    )
  ...
  it should "Test Vector - 1.1 : Generate and verify a specified sum composition signature at t = 1 using a provided seed, message, and height" in {
    ...
    val specOut_sig_1 = Proofs.Signature.KesSum(
      ...
      Vector(
        "6d35211032dfede271b1c311f84b3dabfaf0a664c2c6a16eb7b6a3b3130ebf35".unsafeStrictBytes
      )
    )
  ...
  it should "Test Vector - 2 : Generate and verify a specified sum composition signature at t = [0, 1, 2, 3] using a provided seed, message, and height" in {
    val kesSum = new KesSum()
    val specIn_seed = "cd6fbfd1305556ca26b98077c7b1b0df79559c09f693fe0fc920f9f53fb0959f".hexStringToBytes
    val specIn_height = 2
    val specIn_time = 0
    val specIn_msg = "687564646c6564206d6173736573207769746820736f636b73".hexStringToBytes
    ...
    val specOut_sig_0 = Proofs.Signature.KesSum(
      ...
      Vector(
        "5a856ffe0c9c680312a0847a56efa48f230da440d435ef8a6b2f5a5c5e140476".unsafeStrictBytes,
    ...
    val specOut_sig_1 = Proofs.Signature.KesSum(
      ...
      Vector(
        "a5bef7f1979ed0d776fed04c50c27c221b2f834b369744b4b84bc10e742fd396".unsafeStrictBytes,
        "7fcd9f9bd1c918654416cdcd2ed908a0f978c58f2123ae896d9df28b42c59367".unsafeStrictBytes
      )
    )
    val specOut_sig_2 = Proofs.Signature.KesSum(
      ...
      Vector(
        "9183ed1e702fc2f4983bc461e551d80df3d21b4eb284448e9e35f8a5691d92da".unsafeStrictBytes,
    ...
    val specOut_sig_3 = Proofs.Signature.KesSum(
      ...
      Vector(
        "5b4b52bc5dd65cb4c8e6ab2faa906c595bc607fab3a1f9f17f2ccf5ddcf798a1".unsafeStrictBytes,
        "615244e7bd05088fb462ba9e7b995d71129b91b42652c06780b17936eb456461".unsafeStrictBytes
      )
    )
  ...
  it should "Test Vector - 3 : Generate and verify a specified sum composition signature at t = [0, 2, 5, 7] using a provided seed, message, and height" in {
    val kesSum = new KesSum()
    val specIn_seed = "36d37def07d10f7acb1570cca5b56237b3d5700fd4f5e5b5c44d6af09f2c2ffb".hexStringToBytes
    val specIn_height = 3
    val specIn_time = 0
    val specIn_msg = "6172726976696e67206f6e2074696d6520616e64206c617465".hexStringToBytes
    ...
    val specOut_sig_0 = Proofs.Signature.KesSum(
      ...
      Vector(
        "a5b68a7fad1976bc2f38a46279eca5624f303236f334663e08bbc876765c4533".unsafeStrictBytes,
        "581b77b90035b18faa4ea080cf7d653902d9c9903539f21156c948ec1a39d0fb".unsafeStrictBytes,
    ...
    val specOut_sig_1 = Proofs.Signature.KesSum(
      ...
      Vector(
        "e65e5c7a60a9e849bb1ce1f6ce2f6a5e018e8876f0842846555dc5ca78cdce8f".unsafeStrictBytes,
        "b22e36aad1b810dbcca01681cf9b4273633aa5467d3a36ce215f94f194c9a99b".unsafeStrictBytes,
        "0ada5190f9f8a7ac5d8ba424dbc29ab4135444bbe459a77c598032d60c8d5b8e".unsafeStrictBytes
      )
    )
    val specOut_sig_2 = Proofs.Signature.KesSum(
      ...
      Vector(
        "5e1923f93aff941e5d9a7b259c8589dbe088d4540aa729887781d27905002907".unsafeStrictBytes,
        "95e63597096d10330505e0d0c505c46dd0388c4a6cb6f033d060ece90c8ee966".unsafeStrictBytes,
    ...
    val specOut_sig_3 = Proofs.Signature.KesSum(
      ...
      Vector(
        "a0b175ed12fecdc8b686da7d448101e8e407d8e33687288a638862bf62dd5e25".unsafeStrictBytes,
        "164717632cf3e0016d84dbaa60bd593e3bc50b7dfece3cc1adb79aa99583fc63".unsafeStrictBytes,
        "2c8b7318be3bcf7963fed0545fcae11ab48d60163487a7cf3e8574c36e5d75e0".unsafeStrictBytes
      )
    )
  ...
  it should "Test Vector - 4 : Generate and verify a specified sum composition signature at t = [0, 5, 10, 15] using a provided seed, message, and height" in {
    val kesSum = new KesSum()
    val specIn_seed = "351f09534baf61171893903ab6f122b82ff21dd775f3d853fcd52ee91cb40178".hexStringToBytes
    val specIn_height = 4
    val specIn_time = 0
    val specIn_msg = "776f6e6465722077686572652077696474682077656e74".hexStringToBytes
    ...
    val specOut_sig_0 = Proofs.Signature.KesSum(
      ...
      Vector(
        "fd2a8bb21fff75a6db541253f5a48e652d882dba3475edabb5145c2d95a7f70e".unsafeStrictBytes,
        "551c64f9e4bcc5996f15ca8ab54d1f3d7fda472ac2174f9706332abe9940f7e5".unsafeStrictBytes,
        "640652610bfa34bdc65fed175f6a4997ac2b95aa7e948b6b5df2df5826d62ed9".unsafeStrictBytes,
    ...
    val specOut_sig_1 = Proofs.Signature.KesSum(
      ...
      Vector(
        "1729eaa48403f75cc25f678f36467764fb3af1a926e30a6b27efbdaf0cf3d13e".unsafeStrictBytes,
        "8ff3f095b1d1f6d6727aa3197c7e3c2e5fb4db14d7b75e6694a40d5e1a757352".unsafeStrictBytes,
        "46e57576ca928be69a373b957e4f0641a886806f6c87ce0679096daedb311f32".unsafeStrictBytes,
        "b737aa8e49a4b642a1162e0124a39c3bba4d83fee4d3747816e38482e6d2ae86".unsafeStrictBytes
      )
    )
    val specOut_sig_2 = Proofs.Signature.KesSum(
      ...
      Vector(
        "74a6f25b5a9a99049f12c05abdbe5e852c767dbeb6ca79689b148434de8e3433".unsafeStrictBytes,
        "c95a8684e9590035520e33074985b2ab2f14b5f072fc3ad2c450d23bf4a08f58".unsafeStrictBytes,
        "215c74ddbd507b6227beaf1a13a53ee843b2fb2edaca856b67590cdb66c6d818".unsafeStrictBytes,
    ...
    val specOut_sig_3 = Proofs.Signature.KesSum(
      ...
      Vector(
        "07e5324bafee617d5bfab36b357bf8bad39e1fdf41cd28bd0881e6dec45b10de".unsafeStrictBytes,
        "b0fb6589fe3b694650ec8c847f41b6525ef672632ede69cf0330c630ecd414ec".unsafeStrictBytes,
        "6d763b9fcf4de3c806d272b022fb48fb29e366de8da178fbf3fc55ddaf4a1e08".unsafeStrictBytes,
        "df602c5c6d0eafd2db7c6de7f0ee0ca72e12579450808c3827fb0cdc42836f63".unsafeStrictBytes
      )
    )
  ...
  it should "Test Vector - 5 : Generate and verify a specified sum composition signature at t = [0, 10, 21, 31] using a provided seed, message, and height" in {
    val kesSum = new KesSum()
    val specIn_seed = "c77bbf01a20dea8cfbd9acce52134a845c67bfd9b2cfa5c115f3a9c8597dcd03".hexStringToBytes
    val specIn_height = 5
    val specIn_time = 0
    val specIn_msg = "6d65206f72206974202d206569746865722077617920796f75206a756d70206f6666".hexStringToBytes
    ...
    val specOut_sig_0 = Proofs.Signature.KesSum(
      ...
      Vector(
        "2398f25f7637ae13081ba4b7674b9123f54eab960ec751a0166d76dce379b84c".unsafeStrictBytes,
        "3ab1ccf0e083de049cfbe02e037d23ee8173af82531d8b4fd3a6ee2e4881be3d".unsafeStrictBytes,
        "47803271bc0b85a8bee2e04ad1a2dbe7b66457d04912c65909027f794d971038".unsafeStrictBytes,
        "a0d5cedc00c1993ea3bc06c5f8d196a1902266266d51390ef5bc15073a5be086".unsafeStrictBytes,
    ...
    val specOut_sig_1 = Proofs.Signature.KesSum(
      ...
      Vector(
        "14ec66d47c77c530382146ddffce027a7d14221f336f5ac3fc37cc369c1c19bf".unsafeStrictBytes,
        "c8c437996395666af653895d0b1e74b2bd8771bd0c96ec78d2f3a2c6a8ad434f".unsafeStrictBytes,
        "0c86200d9fbf50c21a5e03e2804ddacc19cb8b86e6ace577fa7813b39046c405".unsafeStrictBytes,
        "0e036b4627a99ce67f9e94452f6837018123b354654129e19f4dbb70429eb891".unsafeStrictBytes,
        "a5ae34468d39e8c5bbf8b9427444f1d507ce5678b5a73d4d2937b0dffe190f3e".unsafeStrictBytes
      )
    )
    val specOut_sig_2 = Proofs.Signature.KesSum(
      ...
      Vector(
        "c77f68fe69b444a67b5544d59635dd5391cf065849c5f443705be9f5f080d9f5".unsafeStrictBytes,
        "23273d7995ee43d27d4ab9320774707f50b6d2170f1648540167db548d1032ea".unsafeStrictBytes,
        "b8439adb5dec5d6c8775cfadfc6568bd3682a08a5d328452b7823ceeff59a984".unsafeStrictBytes,
        "8fab6b378cfa4554103345586bdf2db37897c9fdc91e0d378e16bfced6f44d82".unsafeStrictBytes,
    ...
    val specOut_sig_3 = Proofs.Signature.KesSum(
      ...
      Vector(
        "4179e8cf03735b99189a37614801e8f5f608c6bd11878fd24fffc47da7b54dd0".unsafeStrictBytes,
        "781125c39719d6c58c554d1b0203aa681db2bedf056c65897fec0faa18c770d9".unsafeStrictBytes,
        "9cd7efa15e265d6398ca38b482ac117584c1a8bac10a39415b6fb9462b69d978".unsafeStrictBytes,
        "6056f6e9d54b77c4c4d29b7588881938859bab939a7f7dea21d59804683edbc7".unsafeStrictBytes,
        "7feb24f2a47efff49217759e3e76af0def79946407710c243c19e0b4f131b326".unsafeStrictBytes
      )
    )
