...
/**
 * Mediator of address states inserted to a data store. Based on the Mediator software design pattern.
 * For more information, refer to <a href="https://en.wikipedia.org/wiki/Mediator_pattern">Mediator pattern</a>
 *
 * @tparam F the effect-ful context to retrieve the value in
 */
trait AddressStateMediatorAlgebra[F[_]] {

  /**
   * Mediate after insertion of an address state.
   *
