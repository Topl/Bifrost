...
import co.topl.utils.codecs.binary.scodecs.crypto.publicKeyCodec
import co.topl.utils.codecs.binary.scodecs.valuetypes.{byteCodec, listCodec, uIntCodec}
import scodec.Codec
import scodec.codecs.discriminated
import co.topl.utils.codecs.binary.scodecs.transformers._
