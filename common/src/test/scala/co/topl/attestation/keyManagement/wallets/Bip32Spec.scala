...
import co.topl.attestation.keyManagement.wallets.Bip32.{derivePrivateKey, derivePublicKey, hardened, publicKey}
import org.scalatest.flatspec.AnyFlatSpec
import scodec.bits._

// BIP 0032 TestVectors are from https://en.bitcoin.it/wiki/BIP_0032_TestVectors
class Bip32Spec extends AnyFlatSpec {

  "Deterministic Wallet" should "generate and derive keys (test vector #1)" in {
    val m = Bip32.generate(hex"000102030405060708090a0b0c0d0e0f")
