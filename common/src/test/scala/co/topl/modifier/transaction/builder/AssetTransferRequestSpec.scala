...
//      )
//
//      val result = fromAssetTransferRequest[PublicKeyPropositionCurve25519](request, polyBoxInputs, List())
//
...
//      )
//
//      val result = fromAssetTransferRequest[PublicKeyPropositionCurve25519](request, List(), List())
//
//      result shouldBe Symbol("left")
...
//      )
//
//      val result = fromAssetTransferRequest[PublicKeyPropositionCurve25519](request, polyInputs, List())
//
//      result shouldBe Symbol("left")
//      result.left.value shouldBe UnsignedTransferFailures.EmptyInputs
//    }
...
//      )
//
//      val result = fromAssetTransferRequest[PublicKeyPropositionCurve25519](request, polyInputs ++ polyInputs, List())
//
//      result shouldBe Symbol("left")
...
//        )
//
//        val result = fromAssetTransferRequest[PublicKeyPropositionCurve25519](request, polyInputs, assetBoxes)
//
//        result shouldBe Symbol("left")
//        result.left.value shouldBe UnsignedTransferFailures.DuplicateInputs
//    }
...
//        )
//
//        val result = fromAssetTransferRequest[PublicKeyPropositionCurve25519](request, polyInputs, inputAssetBoxes)
//
//        result shouldBe Symbol("left")
