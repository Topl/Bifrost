...
//import co.topl.modifier.transaction.builder.Builder.BoxPickingStrategies
...
//
//        val buildResult =
//          Builder.buildTransfer[PublicKeyPropositionCurve25519](boxReader, request, BoxPickingStrategies.All)
//
...
//        )
//
//        val buildResult = Builder.buildTransfer[PublicKeyPropositionCurve25519](
//          boxReader,
//          request,
//          BoxPickingStrategies.Specific(List(specificBox.id))
//        )
//
...
//
//        val buildResult =
//          Builder.buildTransfer[PublicKeyPropositionCurve25519](boxReader, request, BoxPickingStrategies.SmallestFirst)
//
