...
object Dependencies {
  ...
  val protobufSpecsVersion = "2.0.0-alpha4+1-d751a916-SNAPSHOT" // scala-steward:off // TODO requires protobuf release
  val bramblScVersion = "2.0.0-alpha4+6-856674e0-SNAPSHOT" // scala-steward:off
