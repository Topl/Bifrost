...
import co.topl.genus.orientDb.instances.SchemaCanonicalHead.CanonicalHead
...
object VertexSchemaInstances {
  ...
  trait Instances {
    ...
    val canonicalHeadSchema: VertexSchema[CanonicalHead.type] = SchemaCanonicalHead.make()
