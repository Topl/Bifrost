...
import co.topl.genus.orientDb.instances.SchemaTxo
...
import co.topl.genus.orientDb.instances.VertexSchemaInstances.instances.txoSchema
import co.topl.genus.orientDb.instances.SchemaTxo.Field
