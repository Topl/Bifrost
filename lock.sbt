...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.typesafe.akka" % "akka-parsing_2.12" % "10.0.6",
  ...
  "org.scalanlp" % "breeze-natives_2.12" % "0.13",
  "org.scalanlp" % "breeze-viz_2.12" % "0.13",
...
// LIBRARY_DEPENDENCIES_HASH f7e3569c4da91ac43e40e3bf3efef5c19a15d4da
