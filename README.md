...
1. To run integration tests:
   ...
   1. Build, Run, and Cleanup the Integration Test via Docker:
      ...
      - On Windows systems, run: `IMAGE_ID=$(docker build -q -f it/Dockerfile .) && docker run --rm -v -v //var/run/docker.sock:/var/run/docker.sock $IMAGE_ID && docker image rm -f $IMAGE_ID`
